...
for i, d in enumerate(max_depth):
	...
	for train_index, test_index in kf:
		...
		train_errors[index],test_errors[index] = learn_and_measure(X_train, y_train, X_test, y_test, min_samples_leaf=d)
		index += 1
...
# Start a new figure 
pl.figure()
pl.title('Decision Trees: training error and testing error v.s. min. sample for leaf nodes')
